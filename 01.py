...
from PyQt5.QtWidgets import QApplication, QTableWidgetItem, QHeaderView, QWidget, QTableWidget
...
class MyWidget(QWidget):
    ...
    def update_check(self):
        ...
        count = [int('0' + self.tableWidget.item(i, 2).text()) for i in range(self.tableWidget.rowCount())]
        sum_of = 0
